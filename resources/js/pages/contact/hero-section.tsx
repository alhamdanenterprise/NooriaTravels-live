import { Headset, MapPin, MessageCircle, Plane } from 'lucide-react';

const floatingCards = [
    { icon: MessageCircle, label: 'WhatsApp Chat', className: 'top-2 left-4 rotate-[-4deg] animate-float', delay: '0s' },
    { icon: Headset, label: '24/7 Support', className: 'top-28 right-2 rotate-[3deg] animate-float', delay: '0.8s' },
    { icon: MapPin, label: 'Visit Our Office', className: 'bottom-16 left-10 rotate-[2deg] animate-float', delay: '1.6s' },
];
        ...
        <section className="from-brand-navy to-brand-blue relative overflow-hidden bg-gradient-to-br">
            ...
            <div className="relative mx-auto grid max-w-7xl gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:items-center lg:px-8 lg:py-28">
                <div>
                    ...
                    <h1 className="mt-3 text-4xl leading-tight font-bold text-white sm:text-5xl">Contact Us</h1>
