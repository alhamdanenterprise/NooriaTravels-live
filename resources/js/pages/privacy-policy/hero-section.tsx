    ...
    return (
        <section className="from-brand-navy to-brand-blue relative overflow-hidden bg-gradient-to-br">
            ...
            <div className="relative mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8 lg:py-24">
                ...
                <h1 className="mt-3 text-4xl leading-tight font-bold text-white sm:text-5xl">Privacy Policy</h1>
                <p className="mt-5 max-w-2xl text-base text-white/85 sm:text-lg">
                    How Nooria Travels collects, uses, and protects your personal information.
                </p>
